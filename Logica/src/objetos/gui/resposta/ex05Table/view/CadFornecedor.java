		...
		if (botao.equals(btAdiciona)) {
			...
			if (linha >= 0) {
				...
				if (table.getRowSorter() != null) {
					// Solicida ao ordenador para ajustar a linha segunda posiççao na tela
					
					linha = table.getRowSorter().convertRowIndexToModel(linha);

				}

				int op = JOptionPane.showOptionDialog(this, "confirma a exclusão desse produto? ", "Remover produto",
