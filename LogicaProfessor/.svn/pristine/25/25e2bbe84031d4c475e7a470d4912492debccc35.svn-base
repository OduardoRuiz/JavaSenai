	...
	public void actionPerformed(ActionEvent ev) {
		...
		try {
			if (item.equals(mntmEncriptar)) {
				...
				try (CipherOutputStream cos =  new CipherOutputStream(new FileOutputStream(new File(nomeArquivoDestino)), getCipher());
				...
				try (CipherInputStream cis = new CipherInputStream(new FileInputStream(new File(nomeArquivoOrigem)),  getCipher());
