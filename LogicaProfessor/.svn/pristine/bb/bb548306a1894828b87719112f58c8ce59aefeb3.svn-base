package objetos.regex.respostas;

import static objetos.gui.lib.SwUtil.criaBotao;
import static objetos.gui.lib.SwUtil.criaPainel;
...
public class ScanTest extends JFrame implements ActionListener {
	...
	// FONE: "[[+999 ](99) ][9]9999-9999"
	String fone = "((\\+[1-9][0-9]{1,2} )?\\([1-9][0-9]\\) )?9?[0-9]{4}-[0-9]{4}";

	// RG: "[99]9.999.999[-9|X]"
	String rg = "[0-9]{1,3}.[0-9]{3}.[0-9]{3}(-([1-9]|X))?";

	// CPF: "[99]9.999.999-99"
	String cpf = "[0-9]{1,3}.[0-9]{3}.[0-9]{3}-[0-9]{2}";

	// CNPJ: "[99]9.999.999/9999-99"
	String cnpj = "[0-9]{1,3}.[0-9]{3}.[0-9]{3}/[0-9]{4}-[0-9]{2}";

	// E-mail: "[xx.]xx@xxxxx.xxxxx.xxxxx"
	String email = "(\\w+.)*\\w+@\\w+(.\\w+){1,2}";
