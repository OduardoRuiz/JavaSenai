...
import jdbc.exercicio.ex02.dao.CompraDao;
import jdbc.exercicio.ex02.dao.DaoException;
...
public class TelaCompra extends JFrame implements ActionListener {
	...
	public void iniciarAConexao() throws DaoException {
		cadastro = new CompraDao();
	}
