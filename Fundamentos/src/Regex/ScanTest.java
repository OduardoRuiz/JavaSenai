...
public class ScanTest extends JFrame implements ActionListener {
	...
	String fone ="(([+]{0,1}[0-9]{0,2}){0,1} {0,1}[0-9]{0,2}){0,1} {0,1}[1-9]{0,1} {0,1}[1-9]{4}(-{0,1})[1-9]{4}";

	// RG: "[99]9.999.999[-9|X]"
	String rg = "[0-9]{1,2}.[0-9]{3}.[0-9]{3}-[(0-9)|[.]]{1}";

	// CPF: "[99]9.999.999-99"
	String cpf = "[0-9]{1,3}.[0-9]{3}.[0-9]{3}-[0-9]{2}";

	// CNPJ: "[99]9.999.999/9999-99"
	String cnpj = "[0-9]{1,2}.[0-9]{3}.[0-9]{3}/[0-9]{4}-[0-9]{2}";

	// E-mail: "[xx.]xx@xxxxx.xxxxx.xxxxx"
	String email = "";//"[xx.]{X}@[xx.]{X}.[xx.]{X}.([xx.]{X}){0,1}";
